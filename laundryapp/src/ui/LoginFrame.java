...
public class LoginFrame extends JFrame {
	...
	public LoginFrame() {
		...
		tfPassword.setBounds(43, 161, 338, 25);
		...
		btnLogin.setBounds(145, 208, 130, 45);
		contentPane.add(btnLogin);
		
		JLabel lblDesc = new JLabel("Kamu malas nyuci? Sini kami cuciin!");
